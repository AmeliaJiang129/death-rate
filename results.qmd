...
### General Trend for Death Number Over Time
...
Finally, we will analyze the similarity of the distribution of causes of death in different geographic areas, with Pricipal Component Analysis (PCA) method.
